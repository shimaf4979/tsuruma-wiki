          ...
          <div className='mb-6'>
            ...
            {isPreview ? (
              <div className='border border-koala-300 rounded-lg p-8 min-h-[400px] bg-white'>
                <div className='prose max-w-none [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mt-12 [&_h1]:mb-8 [&_h1]:text-primary-900 [&_h1]:border-b-2 [&_h1]:border-primary-500 [&_h1]:pb-2 [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-6 [&_h2]:text-koala-900 [&_h2]:border-b-2 [&_h2]:border-koala-300 [&_h2]:pb-2 [&_h3]:text-2xl [&_h3]:font-bold [&_h3]:mt-8 [&_h3]:mb-4 [&_h3]:text-koala-800 [&_h3]:border-b-2 [&_h3]:border-koala-200 [&_h3]:pb-2 [&_p]:mb-6 [&_p]:leading-8 [&_p]:text-koala-700 [&_ul]:list-disc [&_ul]:pl-8 [&_ul]:mb-6 [&_ul>li]:mb-3 [&_ol]:list-decimal [&_ol]:pl-8 [&_ol]:mb-6 [&_ol>li]:mb-3 [&_blockquote]:border-l-4 [&_blockquote]:border-primary-300 [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-koala-600 [&_blockquote]:my-6 [&_blockquote]:bg-koala-50 [&_pre]:bg-koala-900 [&_pre]:text-white [&_pre]:p-6 [&_pre]:rounded-lg [&_pre]:my-6 [&_pre]:overflow-x-auto [&_code]:bg-koala-100 [&_code]:px-2 [&_code]:py-1 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono [&_code]:text-koala-900 [&_a]:text-primary-600 [&_a]:hover:text-primary-700 [&_a]:underline [&_a]:decoration-primary-300 [&_a]:hover:decoration-primary-500 [&_a]:transition-colors [&_a]:duration-200 [&_img]:max-w-full [&_img]:h-auto [&_img]:rounded-lg [&_img]:my-6 [&_hr]:my-10 [&_hr]:border-koala-200 [&_table]:w-full [&_table]:border-collapse [&_table]:my-6 [&_table]:rounded-lg [&_table]:overflow-hidden [&_thead]:bg-koala-50 [&_th]:border [&_th]:border-koala-300 [&_th]:px-6 [&_th]:py-3 [&_th]:text-left [&_th]:text-koala-900 [&_th]:font-medium [&_td]:border [&_td]:border-koala-300 [&_td]:px-6 [&_td]:py-3 [&_div]:mb-6 [&_ul>li::marker]:text-primary-500 [&_ol>li::marker]:text-primary-500 [&_ol>li::marker]:font-medium [&_pre_code]:bg-transparent [&_pre_code]:text-white [&_pre_code]:p-0 [&_tbody_tr:hover]:bg-koala-50'>
                  <div
